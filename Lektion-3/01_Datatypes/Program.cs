...
string uri_1 = "c:\\users\\annelie\\document";
string uri_2 = @"c:\users\annelie\document";
...
*/
/*
Integraler & Floationg ponts
_______________________________________________________________

        Type                Bites           Range (min, max)
_______________________________________________________________
...
____________________________________________________________________________________________       
        Type               Bites           Decimal Range       
____________________________________________________________________________________________
       
       * float              4               6-9 digits          f eller F
       * double             8               15-16 digits        inget eller d eller D
       * decimal            16              28-29 digits        m eller M *säkra med decimal* 
...
double doubleValue = 0.1 + 0.1 + 0.1;  // 0.3
...
/*
 Guid/uuid (Globally Uniqe Identifier)
______________________________________________________________________________________________________________________
Guid                    16 bytes                    Guid.NewGuid()                  8428-------
