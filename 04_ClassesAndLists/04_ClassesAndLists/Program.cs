...
En lista är en dynamisk lista som gör att det går att lägga till och ta bort objekt från listan. Det går även 
att sortera om den. Det finns lite olika typer av listor för olika ändamål. 
...
var user = names.FirstOrDefault(name => name.ToLower() == "Anna");
